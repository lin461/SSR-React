...
app.use('/api', (0, _expressHttpProxy2.default)('http://react-ssr-api.herokuapp.com', {
  // this second argument is due to the API that is used, just to make live easier. specifically for Google OAuth process to avoid security errors.
...
}; //to render array of objects in Routes.js
...
exports.default = function () {
  ...
  switch (action.type) {
    case _actions.FETCH_CURRENT_USER:
      return action.payload.data || false; // if action.payload.data is undefined.
    default:
      return state;
  }
};
